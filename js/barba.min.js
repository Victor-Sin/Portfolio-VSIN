(function (t, n) {
	...
	function T(t, n, r) {
		...
		if (o)
			...
			var v = t[t.length - 1],
				l =
					'string' == typeof v ? v[v.length - 1] === u : void 0 === v;
			e || (s += '(?:' + k(u) + '(?=' + f + '))?'),
				l || (s += '(?=' + k(u) + '|' + f + ')');
		}
				...
				(r.doPage = function (t) {
					...
					try {
						...
						var h = s(
							function () {
								function t() {
									return Promise.resolve(f.j('before', n, c)).then(
										function () {
											var t = !1;
											function r(r) {
												return t
													? r
													: Promise.resolve(f.remove(n)).then(
															function () {
																return Promise.resolve(
																	f.j('after', n, c),
																).then(function () {});
	...
	return new ((function () {
		...
		return (
			...
			(e.go = function (t, n, r) {
				var e;
				if (
					(void 0 === n && (n = 'barba'), this.transitions.isRunning)
				)
					this.force(t);
				else if (
					!(e =
